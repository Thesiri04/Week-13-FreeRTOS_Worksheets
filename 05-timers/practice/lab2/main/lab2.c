...
// Forward declaration for change_led_pattern
void change_led_pattern(led_pattern_t new_pattern);

// Forward declaration for recovery_callback
...
void init_hardware(void) {
    ...
    // Update ADC configuration to use the new driver
    adc1_config_width(ADC_WIDTH_BIT_12);
    adc1_config_channel_atten(ADC1_CHANNEL_0, ADC_ATTEN_DB_12); // Updated from ADC_ATTEN_DB_11

    // Characterize ADC
    adc_chars = calloc(1, sizeof(esp_adc_cal_characteristics_t));
    esp_adc_cal_characterize(ADC_UNIT_1, ADC_ATTEN_DB_12, ADC_WIDTH_BIT_12, 1100, adc_chars); // Updated attenuation
