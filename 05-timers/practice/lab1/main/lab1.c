...
// Forward declaration for dynamic_timer_callback
...
void app_main(void) {
    ...
    if (xBlinkTimer && xHeartbeatTimer && xStatusTimer && xOneShotTimer) {
        ...
        // Create additional timers to increase load
        for (int i = 0; i < 10; i++) {
