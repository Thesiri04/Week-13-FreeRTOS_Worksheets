...
เมื่อ Queue เต็ม การเรียก xQueueSend จะบล็อก หรืออส่งไม่สำเร็จและคืนค่า errQUEUE_FULL
2. เมื่อ Queue ว่าง การเรียก `xQueueReceive` จะเกิดอะไรขึ้น?
xQueueReceive จะบล็อก หรือรับไม่สำเร็จและคืนค่า errQUEUE_EMPTY
3. ทำไม LED จึงกะพริบตามการส่งและรับข้อความ?
LED กะพริบเพื่อแสดงสถานะการส่ง (Sender) และรับ (Receiver) ข้อความใน Queue
